...
## Instalasi dan Setup
  ...
  Download dan install Android Studio dari [Kunjungi GitHub](https://github.com)  <br>
  2. Clone Repository  <br>
        Melakukan clone repository ke lokal komputer:  <br>
  [git clone https://github.com/keisyatan12/ElectroSphere-Inventory.git](https://github.com/keisyatan12/ElectroSphere-Inventory.git)
